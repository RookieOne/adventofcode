defmodule Advent.DaySixteen.PartTwo do
  ...
  def find_match([aunt|aunts], facts) do
    ...
    match = for {key,value} <- aunt_facts do
      is_match(key, value, facts[key])
    end |> Enum.all?
    if match, do: aunt_number, else: find_match(aunts, facts)
  end

  def is_match("trees", aunt_value, fact_value), do: aunt_value > fact_value
  def is_match("cats", aunt_value, fact_value), do: aunt_value > fact_value

  def is_match("pomeranians", aunt_value, fact_value), do: aunt_value < fact_value
  def is_match("goldfish", aunt_value, fact_value), do: aunt_value < fact_value
  
  def is_match(_, aunt_value, fact_value), do: aunt_value == fact_value
